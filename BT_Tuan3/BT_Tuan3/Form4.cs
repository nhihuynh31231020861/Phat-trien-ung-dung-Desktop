...
namespace BT_Tuan3
{
    public partial class ProductForm : Form
    {
        ...
        {
            products.Add(new Product("P01", "Gạo", 120000, 50, "Thực phẩm"));
            products.Add(new Product("P02", "Cà phê", 90000, 30, "Đồ uống"));
            products.Add(new Product("P03", "Muối", 5000, 200, "Gia vị"));
            products.Add(new Product("P04", "Xô nhựa", 45000, 15, "Đồ gia dụng"));
            RefreshList();
        }
